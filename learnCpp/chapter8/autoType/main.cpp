...
//    needs to be added excplicitly - so in this case d2 is NOT const double but "only" double.
// 3) Note that the compiler needs, neverthelss, some sort of "clue", otherwise the code won't compile casue the deduction won't terminate.
// =================================================================================================================================================
// =================================================================================================================================================

...
set projectName=moreEffectiveCppVer1Items
echo "building project %projectName%"

set currDir=%cd%
echo "current directory is:%currDir%"

set cmakeFileFullPath=%currDir%
...
cmake -G "Visual Studio 15 2017 Win64" -DCMAKE_CXX_COMPILER_ARG1=-std=c++11 -DCMAKE_BUILD_TYPE=Debug %cmakeFileFullPath%

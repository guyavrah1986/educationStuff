...
:: get the name of the topic to build (for instance - staticLibraryTopic) as the first argument for this script
set topicName=%1
echo "building project %topicName%"
...
:: invoke the cmake command to create the desired Visual Studio solution
